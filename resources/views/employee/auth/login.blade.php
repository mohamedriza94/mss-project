    ...
    <div>
      ...
      <div class="login-page-container">
        ...
        <div class="login-page-container2">
          <form class="login-page-form" action="{{ route('employee.login.submit') }}" method="POST">
            @csrf
            <input
              type="text"
              id="email"
              name="email"
              placeholder="email"
              class="login-page-textinput input @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}"
            />
            <input
              type="password"
              id="password"
            ...
            <span class="login-page-text3">Employee Login</span>
            <button
              id="loginbtn"
              name="loginbtn"
              type="submit"
            ...
            <label class="login-page-text4">Email :</label>
